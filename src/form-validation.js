        ...
        style={{width:'400px',background:'#cee'}}>
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
                <div className="form-group mb-3">
                    <label htmlFor="cat" className="form-label">หมวดหมู่ *</label>
                ...
                <div className="form-group mb-3">
                    <label htmlFor="file" className="form-label">ภาพสินค้า * (ไม่เกิน 3 ไฟล์ ขนาดสูงสุด 300KB/ไฟล์)</label>
                    ...
                    opts.map((opt,i) => {
                        return(
                            <div className="form-check form-check-inline mb-2">
                                ...
                                <label htmlFor={'opt'+1} className="form-check-label">{opt}</label>
                            </div>
                        )
                    })
                }
